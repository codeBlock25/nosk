...
class CreateUserPage extends RouteFulWidget {
  const CreateUserPage({super.key});

  static CreateUserPage get route => const CreateUserPage();

  @override
  State<CreateUserPage> createState() => _UserRoomPageState();
...
class _UserRoomPageState extends State<CreateUserPage> {
